...
const NotLoginHome = () => {
  ...
  return <div className="bg-gradient-to-t from-indigo-500 via-[#FFE5B2] to-[#FFFFFF] h-[91.4vh] flex justify-center overflow-hidden">
    <div id='nlh-div1' className="grid content-center lg:ml-48 md:ml-36 sm:ml-24 ml-12">
      ...
      <div className="flex justify-center">
        <Link to="/login" className="lg:w-20 lg:h-10 md:w-16 md:h-8 w-12 h-6 border-black border-2 bg-[#FEFEFE] rounded-lg hover:bg-gray-100 grid content-center">
          <p className="md:text-[16px] sm:text-[12px] text-[8px] text-center">시작하기</p>
        </Link>
      </div>
    </div>
