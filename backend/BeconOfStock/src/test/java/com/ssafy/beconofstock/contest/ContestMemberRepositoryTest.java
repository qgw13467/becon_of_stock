...
//    @BeforeTestClass
//    void setContestMemberRepository(){
//
...
//                contestMemberRepository.findByMemberFetch(member);
//
//        System.out.println(predict.getId());
//        Assertions.assertEquals(contestMemberList.get(0),predict);
//
//    }
